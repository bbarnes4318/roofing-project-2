const ensureLeadSourcesSchema = async (prisma) => {
  try {
    console.log('🔧 Ensuring lead_sources schema and projects.lead_source_id column exist...');
    ...
    console.log('✅ Lead sources schema ensured');
  } catch (err) {
    console.warn('⚠️ Failed to ensure lead sources schema (will continue without it):', err?.message || err);
  }
};

module.exports = { ensureLeadSourcesSchema };
