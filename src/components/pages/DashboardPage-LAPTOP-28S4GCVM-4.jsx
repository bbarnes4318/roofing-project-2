...
const PROJECT_PHASES = [
  { id: 'lead', name: 'Lead', initial: 'L', color: '#94A3B8', gradientColor: 'from-purple-400 to-purple-600', bgColor: 'bg-purple-50', textColor: 'text-purple-700', borderColor: 'border-purple-200' },
  { id: 'prospect', name: 'Prospect', initial: 'P', color: '#3B82F6', gradientColor: 'from-orange-500 to-orange-600', bgColor: 'bg-orange-50', textColor: 'text-orange-700', borderColor: 'border-orange-200' },
  ...
  { id: 'execution', name: 'Execute', initial: 'E', color: '#F59E0B', gradientColor: 'from-blue-500 to-blue-600', bgColor: 'bg-blue-50', textColor: 'text-blue-700', borderColor: 'border-blue-200' },
  { id: 'supplement', name: '2nd Supp', initial: 'S', color: '#8B5CF6', gradientColor: 'from-yellow-500 to-yellow-600', bgColor: 'bg-yellow-50', textColor: 'text-yellow-700', borderColor: 'border-yellow-200' },
  { id: 'completion', name: 'Completion', initial: 'C', color: '#14532D', gradientColor: 'from-teal-500 to-teal-600', bgColor: 'bg-teal-50', textColor: 'text-teal-700', borderColor: 'border-teal-200' }
];
    ...
    <div className={`animate-fade-in w-full max-w-full ${isDarkMode ? 'dark' : ''}`}>
        ...
        <div className="flex items-center gap-8 mb-6 flex-wrap">
          ...
          {PROJECT_PHASES.map(phase => (
            <button
              ...
              className={`w-28 h-9 px-4 py-2 text-[10px] font-medium rounded-full transition-colors border flex items-center justify-center gap-2 ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12 items-start overflow-visible">
        ...
        <div className="w-full" data-section="current-alerts">
          <div className={`border-t-4 border-blue-400 shadow-[0_2px_8px_rgba(0,0,0,0.1)] rounded-[8px] rounded-t-[8px] px-4 py-3 pb-6 ${colorMode ? 'bg-[#232b4d]/80' : 'bg-white'} overflow-hidden relative`}>
            <div className="mb-3">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <h1 className={`text-base font-semibold ${colorMode ? 'text-white' : 'text-gray-800'}`}>Current Alerts</h1>
                </div>
              </div>
            ...
            <div className="space-y-2 mt-3 max-h-[500px] overflow-y-auto pr-1 custom-scrollbar">
                ...
                getPaginatedAlerts().map(alert => {
                  ...
                  return (
                    <div key={alertId} className={`${colorMode ? 'bg-[#1e293b] hover:bg-[#232b4d]' : 'bg-white hover:bg-[#F8F9FA]'} rounded-[20px] shadow-sm border transition-all duration-200 cursor-pointer`}>
                      ...
                      <div 
                        className="flex flex-col gap-0.5 p-1 hover:bg-opacity-80 transition-colors cursor-pointer"
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between gap-6">
                          ...
                          {/* Left Section: Project# | Customer | PM - Spread out more */}
                          <div className="flex items-center gap-6 text-[10px] flex-1">
                              {/* Project Number */}
                              <span 
                              ...
                              {/* Separator */}
                              <span className={`text-[10px] ${colorMode ? 'text-gray-400' : 'text-gray-400'}`}>|</span>
                        ...
                        {/* Second Row - Section and Line Item - More room for text */}
                        <div className="flex items-center">
                          {/* Empty space to align with project number start - w-7 circle + gap-6 spacing */}
                          <div className="w-7 flex-shrink-0"></div>
                          <div className="w-6 flex-shrink-0"></div>
                          
                          {/* Section and Line Item Content - More space */}
                          <div className="flex items-center gap-4 text-[10px] overflow-hidden flex-1">
                            {/* Section */}
                            <div className="flex items-center gap-1 flex-shrink-0">
                              <span className={`font-medium ${colorMode ? 'text-gray-400' : 'text-gray-500'}`}>Section:</span>
                              <span className={`font-semibold max-w-[120px] truncate ${colorMode ? 'text-gray-200' : 'text-gray-700'}`} title={sectionName}>
                                {sectionName}
                              </span>
                            </div>
                            
                            {/* Separator */}
                            <span className={`text-[10px] mx-2 ${colorMode ? 'text-gray-400' : 'text-gray-400'}`}>•</span>
