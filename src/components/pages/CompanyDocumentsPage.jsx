...
const Sidebar = ({ 
  ...
  return (
    <div className={`w-64 border-r ${colorMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'} flex flex-col h-full`}>
      {/* Sidebar Header */}
      <div className="p-3 border-b border-gray-200">
        <h2 className="font-semibold text-gray-900 mb-2 text-sm">Folders</h2>
...
const CompanyDocumentsPage = ({ colorMode }) => {
  console.log('CompanyDocumentsPage is rendering!', { colorMode });
  // Core state
      ...
      <div className="h-full flex bg-white">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className={`${colorMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border-b`}>
            ...
            <div className="px-4 py-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Breadcrumb */}
                  <div className="bg-gray-50 rounded px-3 py-1 border border-gray-200">
            ...
            {/* Toolbar Section */}
            <div className={`px-4 py-2 ${colorMode ? 'bg-gray-750 border-gray-700' : 'bg-gray-50 border-gray-200'} border-t`}>
              <div className="flex items-center justify-between">
                {/* Left: Search */}
                <div className="flex-1 max-w-sm">
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={searchQuery}
                      onChange={(e) => setSearchQuery(e.target.value)}
                      className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-1 focus:ring-blue-500 focus:border-transparent bg-white"
                    />
                  </div>
                </div>
