...
const CurrentAlertsSection = ({ 
  ...
  useEffect(() => {
    ...
    <input
        className="px-4 py-2 bg-[var(--color-primary-blueprint-blue)] text-white rounded-lg hover:bg-[var(--color-primary-blueprint-blue-dark)] transition-colors text-sm"
        setAvailableUsers([]);
      }
    };
    fetchUsers();
  }, []);
            className="px-4 py-2 bg-[var(--color-primary-blueprint-blue)] text-white rounded-lg hover:bg-[var(--color-primary-blueprint-blue-dark)] transition-colors"
  // Handle user assignment
  const handleAssignUser = async (userId) => {
    if (!selectedAlertForAssign || !userId) return;
            className="px-3 py-2 bg-[var(--color-success-green)] text-white rounded-lg hover:bg-[var(--color-success-green-dark)] transition-colors text-sm disabled:bg-gray-400 disabled:cursor-not-allowed"
                  ...
                  <div className="px-6 py-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-[var(--color-success-green)] text-white rounded-lg hover:bg-[var(--color-success-green-dark)] transition-colors text-sm"
                      >
                        Project Messages
                      </button>
